...
export interface IERC721ABurnableUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface IERC721ABurnableUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): IERC721ABurnableUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: IERC721ABurnableUpgradeableInterface;
