...
export interface ERC721ABurnableUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface ERC721ABurnableUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): ERC721ABurnableUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: ERC721ABurnableUpgradeableInterface;
