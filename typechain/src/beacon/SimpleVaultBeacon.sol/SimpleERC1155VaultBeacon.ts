...
export interface SimpleERC1155VaultBeaconInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "implementation"
      | "owner"
...
export interface SimpleERC1155VaultBeacon extends BaseContract {
  connect(runner?: ContractRunner | null): SimpleERC1155VaultBeacon;
  waitForDeployment(): Promise<this>;

  interface: SimpleERC1155VaultBeaconInterface;
