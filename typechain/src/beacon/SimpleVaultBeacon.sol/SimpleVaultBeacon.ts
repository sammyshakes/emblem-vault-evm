...
export interface SimpleVaultBeaconInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "implementation"
      | "owner"
...
export interface SimpleVaultBeacon extends BaseContract {
  connect(runner?: ContractRunner | null): SimpleVaultBeacon;
  waitForDeployment(): Promise<this>;

  interface: SimpleVaultBeaconInterface;
