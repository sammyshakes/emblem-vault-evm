...
export interface SimpleERC721VaultBeaconInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "implementation"
      | "owner"
...
export interface SimpleERC721VaultBeacon extends BaseContract {
  connect(runner?: ContractRunner | null): SimpleERC721VaultBeacon;
  waitForDeployment(): Promise<this>;

  interface: SimpleERC721VaultBeaconInterface;
