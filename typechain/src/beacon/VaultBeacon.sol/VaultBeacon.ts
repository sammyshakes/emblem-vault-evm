...
export interface VaultBeaconInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "implementation"
      | "owner"
...
export interface VaultBeacon extends BaseContract {
  connect(runner?: ContractRunner | null): VaultBeacon;
