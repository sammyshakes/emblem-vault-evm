...
export interface ERC721VaultBeaconInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "implementation"
      | "owner"
...
export interface ERC721VaultBeacon extends BaseContract {
  connect(runner?: ContractRunner | null): ERC721VaultBeacon;
  waitForDeployment(): Promise<this>;

  interface: ERC721VaultBeaconInterface;
