...
export interface IVaultCollectionFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IVaultCollectionFactory extends BaseContract {
  connect(runner?: ContractRunner | null): IVaultCollectionFactory;
  waitForDeployment(): Promise<this>;

  interface: IVaultCollectionFactoryInterface;
  ...
  updateBeacon: TypedContractMethod<
    [collectionType: BigNumberish, newBeacon: AddressLike],
    [void],
    "nonpayable"
  >;
