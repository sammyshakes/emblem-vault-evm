...
export interface IERC721AVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface IERC721AVault extends BaseContract {
  connect(runner?: ContractRunner | null): IERC721AVault;
  waitForDeployment(): Promise<this>;

  interface: IERC721AVaultInterface;
