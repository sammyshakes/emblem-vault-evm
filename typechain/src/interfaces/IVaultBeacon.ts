...
export interface IVaultBeaconInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "implementation"
      | "owner"
...
export interface IVaultBeacon extends BaseContract {
  connect(runner?: ContractRunner | null): IVaultBeacon;
  waitForDeployment(): Promise<this>;

  interface: IVaultBeaconInterface;
