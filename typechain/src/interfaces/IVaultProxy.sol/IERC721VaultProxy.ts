...
export interface IERC721VaultProxyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "beacon"
      | "implementation"
...
export interface IERC721VaultProxy extends BaseContract {
  connect(runner?: ContractRunner | null): IERC721VaultProxy;
  waitForDeployment(): Promise<this>;

  interface: IERC721VaultProxyInterface;
  ...
  initialize: TypedContractMethod<
    [name: string, symbol: string, diamondAddress: AddressLike],
    [void],
    "nonpayable"
  >;
