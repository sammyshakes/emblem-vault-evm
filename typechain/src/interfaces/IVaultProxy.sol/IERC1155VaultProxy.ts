...
export interface IERC1155VaultProxyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "beacon"
      | "implementation"
...
export interface IERC1155VaultProxy extends BaseContract {
  connect(runner?: ContractRunner | null): IERC1155VaultProxy;
  waitForDeployment(): Promise<this>;

  interface: IERC1155VaultProxyInterface;
  ...
  initialize: TypedContractMethod<
    [uri: string, diamondAddress: AddressLike],
    [void],
    "nonpayable"
  >;
