...
export interface EmblemVaultDiamondInterface extends Interface {
  getEvent(
...
export interface EmblemVaultDiamond extends BaseContract {
  connect(runner?: ContractRunner | null): EmblemVaultDiamond;
  waitForDeployment(): Promise<this>;

  interface: EmblemVaultDiamondInterface;
